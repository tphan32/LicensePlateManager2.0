...
class LicensePlateManager {
    public:
        ...
        */
        void UpdateLicensePlate(std::string first_name, std::string last_name, PlateNumber plate_number);
        ...
        */
        void UpdateAddress(PlateNumber plate_number, std::string update_address);
        ...
        */
        void UpdateAge(PlateNumber plate_number, int update_age);
        ...
        */
        void UpdateHeight(PlateNumber plate_number, double update_height);
        ...
        */
        void UpdateWeight(PlateNumber plate_number, double update_weight);
        ...
        */
        bool IsUniqueNumber(std::string number);
        ...
        */
        LicensePlateInfo GeneratePlate(std::string first_name, std::string last_name, int age, std::string date_of_birth,
        ...
        */
        LicensePlateInfo CreatePlate(std::string plate_number, std::string first_name, std::string last_name, int age, std::string date_of_birth,
                                    std::string address, double height, double weight);
        ...
        */
        bool RemovePlate(std::string plate_number);
...
* Checks if a license plate number already exists in the manager.
    * @param plate The license plate being checked.
    * @return true if the license plate is not a duplicate, false otherwise
*/
static int IsUnique(void *data, int argc, char **argv, char **col_name);
